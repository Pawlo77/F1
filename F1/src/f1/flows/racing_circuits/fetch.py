...
from . import BASE_URL, CIRCUIT_DIR_PATH, OUTPUT_DIR_PATH
...
def _get_circuit_file_path(name: str) -> str:
    ...
    return os.path.join(CIRCUIT_DIR_PATH, f"{filename}.html")
...
def fetch_data_from_circuits() -> str:
    ...
    circuits_meta_df_path = os.path.join(OUTPUT_DIR_PATH, "circuits_meta.csv")
